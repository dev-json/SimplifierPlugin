package de.jxson.simplifier.plugin.utils;
...
public class ItemCreator {
    ...
    public ItemCreator setItem(ItemStack itemStack)
    {
        this.item = itemStack;
        return this;
    }

    public ItemCreator setItem(Material material, int subId) {
        this.item = new ItemStack(material, 1, (short) subId);
        return this;
    }
    ...
    public ItemCreator setAmount(int amount)
    {
        ...
        {
            throw new IllegalArgumentException("Item amount must be between 1-64");
        }
